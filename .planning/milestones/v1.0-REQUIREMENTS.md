...
- [x] **NOTF-01**: Employee receives booking confirmation email via Graph API
- [x] **NOTF-02**: Employee receives return reminder before return date/time (scheduled Azure Function)
- [x] **NOTF-03**: Manager receives notification when their employee books a vehicle
- [x] **NOTF-04**: Notifications delivered as Teams activity feed notifications with deep links (Teams Adaptive Cards replaced by activity feed — no bot registration needed)
...
| NOTF-04 | Phase 6 | Complete (Teams activity feed, not Adaptive Cards) |
